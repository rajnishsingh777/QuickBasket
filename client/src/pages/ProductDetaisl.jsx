...
const ProductDetails = () => {
  ...
  if (!product) return <p className="mt-16 text-center">Loading product...</p>;
...
{console.log("Related Products inStock:", relatedProducts.map(p => ({ name: p.name, inStock: p.inStock })))}
